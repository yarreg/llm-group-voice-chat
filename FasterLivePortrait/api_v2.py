...
class PredictAudio:
    ...
    async def predict_audio_handler(
        ...
        with temporary_directories(self.results_dir) as (save_dir, temp_dir):
            ...
            duration_sec = 0 # TODO: not implemented
            headers = {"X-Duration-Sec": str(duration_sec)}  # Set actual duration
            return FileResponse(org_mp4, media_type="video/mp4", filename="output.mp4", headers=headers)
